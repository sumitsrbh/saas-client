  ...
  return (
    <Grid container marginTop={8}>
      <Grid container className="sndrw-first-row">
        <Grid item xs={6}>
          <CardBuidler
            cardImgUrl={card1.imgUrl}
            cardHeader={card1.header}
            cardText={card1.text}
            cardBadge={card1.badge}
          />
        </Grid>
        <Grid item xs={6}>
          <CardBuidler
            cardImgUrl={card2.imgUrl}
            cardHeader={card2.header}
            cardText={card2.text}
          />
        </Grid>
      </Grid>
      ...
      <Grid container className="sndrw-second-row">
        <Grid item xs={6}>
          <CardBuidler
            cardImgUrl={card3.imgUrl}
            cardHeader={card3.header}
            cardText={card3.text}
          />
        </Grid>
        <Grid item xs={6}>
          <CardBuidler
            cardImgUrl={card4.imgUrl}
            cardHeader={card4.header}
            cardText={card4.text}
          />
        </Grid>
      </Grid>
      ...
      <Grid container className="sndrw-third-row">
        ...
        <Grid item xs={6}>
          <CardBuidler
            cardImgUrl={card5.imgUrl}
            cardHeader={card5.header}
            cardText={card5.text}
          />
        </Grid>
        <Grid item xs={6}>
          <CardBuidler
            cardImgUrl={card6.imgUrl}
            cardHeader={card6.header}
            cardText={card6.text}
          />
        </Grid>
      </Grid>
      <Grid container className="sndrw-fourth-row">
        <Grid item xs={6}>
          <CardBuidler
            cardImgUrl={card7.imgUrl}
            cardHeader={card7.header}
            cardText={card7.text}
          />
        </Grid>
        <Grid item xs={6}>
          <CardBuidler
            cardImgUrl={card8.imgUrl}
            cardHeader={card8.header}
            cardText={card8.text}
          />
        </Grid>
      </Grid>
